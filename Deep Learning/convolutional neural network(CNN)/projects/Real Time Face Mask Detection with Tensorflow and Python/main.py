...
# Change it to label_map.pbtxt, I had to replace it with label_map.pbtxt.txt
with open(ANNOTATION_PATH+'\label_map.pbtxt.txt','w') as f:
    for label in labels:
        f.write('item{\n')
        f.write('\tname:\'{}\'\n'.format(label['name']))
        f.write('\tid:{}\n'.format(label['id']))
...
# from  object_detection.protos.DetectionModel import 
...
pipeline_config.train_input_reader.label_map_path= ANNOTATION_PATH + '/label_map.pbtxt.txt'
...
# from object_detection import mo