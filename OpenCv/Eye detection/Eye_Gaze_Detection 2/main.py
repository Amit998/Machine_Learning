...
while True:
    ...
    for face in faces:
        ...
        # # cv2.putText(frame,f"left side {str(left_side_white)}",(50,100),font,2,(255,255,255),3)
        # # cv2.putText(frame,f"right side {str(right_side_white)}",(100,150),font,2,(255,255,255),3)
